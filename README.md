...
- [Truist modeling competition](https://github.com/KajariBhaumik/Truist_modeling_competition): The objective of the modeling challenge was to build a binary classification model - predicting whether a client will enroll in a Certificate of Deposit (CD) or not. The submission were scored on Kaggle and the ROC AUC score was generated. Based on the performance of the model, we got <b> 3rd rank </b> in the Inter-University comptetion.
